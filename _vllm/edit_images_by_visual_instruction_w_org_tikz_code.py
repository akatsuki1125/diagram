...
You are given:
1) the original TikZ code of a diagram, and
2) an image of that diagram with visual edit instructions overlaid on it.

Interpret both:
- the structure and content of the diagram from the original TikZ code, and
- the edit instructions from the image.
...
def edit_image_to_tikz(client: OpenAI, model: str, original_tikz_code: str, img_path: str):
...
if __name__ == "__main__":
    ...
    save_dir = Path("work") / "visual_instruction_editing" / args.model / "tikz_code_w_org_tikz_code"
