...
Interpret the diagram, and return only a complete standalone LaTeX document that compiles the given diagram.
...
if __name__ == "__main__":
    ...
    save_dir = Path("work") / args.model / "reconstruct_tikz_code"
    save_dir.mkdir(parents=True, exist_ok=True)
    edited_stem = org_img_name.replace("org", "reconstructed")
