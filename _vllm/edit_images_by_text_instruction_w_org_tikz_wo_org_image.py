...
EDITING_PROMPT = r"""You are given the TikZ code of a diagram.
Interpret the diagram using the TikZ code, apply the following edit instruction, and return only a complete standalone LaTeX document that compiles the resulting diagram.
...
def edit_image_to_tikz(client: OpenAI, model: str, original_tikz_code: str, edit_instruction: str):
...
if __name__ == "__main__":
    ...
    save_dir = Path("work") / args.model / "tikz_code_w_org_tikz_wo_org_image"
