...
- Resolve ambiguities by referring to the original image for the underlying content and the annotated image for the intended modifications.
...
if __name__ == "__main__":
    ...
    save_dir = Path("work") / "visual_instruction_editing" / args.model / "tikz_code_w_org_image"
