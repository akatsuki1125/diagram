...
EDITING_PROMPT=r"""You are given an image of a diagram.
Interpret the diagram, apply the following edit instruction to it, and return only a complete standalone LaTeX document that compiles the resulting diagram.
...
def edit_image_to_tikz(client: OpenAI, model: str, edit_instruction: str, img_path: str):
...
if __name__ == "__main__":
    ...
    save_dir = Path("work") / args.model / "tikz_code"
