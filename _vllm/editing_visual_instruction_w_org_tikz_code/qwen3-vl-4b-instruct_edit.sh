...
#     python _vllm/edit_images_by_visual_instruction_w_org_tikz_code.py \
#         --model "$MODEL" \
#         --base_url "$BASE_URL" \
#         --api_key "$API_KEY" \
#         --original_tikz_code "$original_tikz_code" \
#         --org_img_file "$annotated_img_file"
# done
...
jq -rn \
  --slurpfile visual data/visual_instruction/nouhin_data_20260325.jsonl \
  --slurpfile text data/text_instruction/nouhin_data_reviewer1_20260212.jsonl '
